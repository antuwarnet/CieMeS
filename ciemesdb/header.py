            ...
            if ':-' in header_key:
                ...
                if '||' in detection_string[0]:
                    ...
                    for d in detection_strings:
                        if d in hstring and detection_string[1] not in ciemes.ignore_cms: # ignore cms thingy - what i mean is check if the cms_id is not in the ignore list
                            if ciemes.strict_cms == [] or detection_string[1] in ciemes.strict_cms:
                    ...
                    for check_key in keys_to_match:
                        if match_status == '0' or match_status == '1':
                            ...
                            match_status = '2'
                    if match_status == '1' and detection_string[1] not in ciemes.ignore_cms:
                        if ciemes.strict_cms == [] or detection_string[1] in ciemes.strict_cms:
                            return ['1', detection_string[1]]
                else:
                    if detection_string[0] in hstring and detection_string[1] not in ciemes.ignore_cms:
                        if ciemes.strict_cms == [] or detection_string[1] in ciemes.strict_cms:
                            return ['1', detection_string[1]]
            ...
            if ':-' in detection_key:
                ...
                if '||' in regex_key[0]:
                    ...
                    for match_string in match_strings:
                        ...
                        if regex_match_status != None and regex_key[1] not in ciemes.ignore_cms:
                            if ciemes.strict_cms == [] or regex_key[1] in ciemes.strict_cms:
