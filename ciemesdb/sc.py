            ...
            if ':-' in detection_key:
                ...
                if '||' in detection_array[0]:
                    ...
                    for detection_string in detection_strings:
                        if detection_string in page_source_code and detection_array[1] not in ciemes.ignore_cms: # check if the cms_id is not in the ignore list
                            if ciemes.strict_cms == [] or detection_array[1] in ciemes.strict_cms:
                    ...
                    for match_string in match_strings:
                        if match_status == '0' or match_status == '1':
                            ...
                            match_status = '2'
                    if match_status == '1' and detection_array[1] not in ciemes.ignore_cms:
                        if ciemes.strict_cms == [] or detection_array[1] in ciemes.strict_cms:
                            return ['1', detection_array[1]]
                else:
                    if detection_array[0] in page_source_code and detection_array[1] not in ciemes.ignore_cms:
                        if ciemes.strict_cms == [] or detection_array[1] in ciemes.strict_cms:
                            return ['1', detection_array[1]]
            ...
            if ':-' in detection_key:
                ...
                if '||' in detection_array[0]:
                    ...
                    for detection_regex_string in detection_regex_strings:
                        ...
                        if regex_match_status != None and detection_array[1] not in ciemes.ignore_cms:
                            if ciemes.strict_cms == [] or detection_array[1] in ciemes.strict_cms:
                                return ['1', detection_array[1]]
                else:
